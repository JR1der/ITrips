...
export const SingleTripPage = () => {
    ...
    if (hasFetchError) {
        return (
            <BaseLayout>
                <ErrorBox type="error" message="An error occurred while fetching the trip." />
            </BaseLayout>
        );
    }
                ...
                <Box my={4} sx={{
                    ...
                    {!isFetchingTrips && !hasFetchError && trip ? (
                        <Box>
                            ...
                            <Card sx={{ p: 2, backgroundColor: 'primary.main', color: 'white', mb: 2 }}>
                                <Box>
                                    <Typography variant="h6" sx={{ p: 1 }}>Trip Name</Typography>
                                </Box>
                                <Box>
